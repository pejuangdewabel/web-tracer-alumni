...
@section('content')
                                                                ...
                                                                <th>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu"
                                                                            ...
                                                                            <a href="{{ route('dataPengumuman',$p->id) }}" class="dropdown-item">
                                                                                <i class="fas fa-info-circle"></i>
                                                                                <strong>Detail</strong>
                                                                            </a>
                                                                            <a href="{{ route('data-pengumuman.edit', $p->id) }}" class="dropdown-item">
                                                                                <i class="fas fa-edit"></i>
                                                                                <strong>Ubah</strong>
                                                                            </a>
                                                                            <form 
                                                                                action="{{ route('data-pengumuman.destroy', $p->id) }}"
                                                                                method="POST"
                                                                                class="d-inline"
                                                                            >
                                                                                @csrf
                                        ...
                                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <form 
                                                    action="{{ route('data-pengumuman.store') }}" 
                                                    method="POST" 
